...
Install PiHole for DNSBL, 81/admin/
```bash
...
Install PiHole for DNSBL and NTP, 81/admin/
```bash
...
Install PiHole for DNSBL, NTP and DHCP server, 81/admin/
```bash
